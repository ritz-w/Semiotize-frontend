            ...
            <div>
                ...
                <div>
                    ...
                    <div className="collection-container" id="style-7">
                        {this.props.collections.sfmoma.map(artist => <CollectionArtistCard artist={artist} />)}
                    </div>
                    <h3 className="collection-title">Kiasma, Finnish National Gallery</h3>
                    <div className="collection-container" id="style-7">
                        {this.props.collections.kiasma.map(artist => <CollectionArtistCard artist={artist} />)}
                    </div>
                    <h3 className="collection-title">Harvard Art Museums</h3>
                    <div className="collection-container" id="style-7">
                        {this.props.collections.harvard.map(artist => <CollectionArtistCard artist={artist} />)}
                    </div>
                    <h3 className="collection-title">RMN-GP (National Network of Museums - Grand Palais)</h3>
                    <div className="collection-container" id="style-7">
                        {this.props.collections.rmngp.map(artist => <CollectionArtistCard artist={artist} />)}
                    </div>
                </div>
                )
            }
